; Minimal dav bf16 memory block/gather LLVM IR smoke test for tools/asc-sim.
;
; This mirrors OpenTileAS simulator/cases/a5_memory_blocks_bf16. The byte
; payload is exposed as bfloat lanes by vsldb/vgatherb, but the final oracle is
; byte-for-byte raw data copied back from UB.

define dso_local ptc_kernel void @dav_memory_blocks_bf16(ptr addrspace(1) %data,
...
entry:
  ...
  %loaded = call <128 x bfloat> @llvm.hivm.vsldb(ptr addrspace(6) null, i32 65537, i32 0, <256 x i1> %mask)
  %gathered = call <128 x bfloat> @llvm.hivm.vgatherb.v310.v128bf16(ptr addrspace(6) inttoptr (i64 32 to ptr addrspace(6)), <64 x i32> %idx, <256 x i1> %mask)
  call void @llvm.hivm.vstsx1.v128bf16(<128 x bfloat> %loaded, ptr addrspace(6) inttoptr (i64 1024 to ptr addrspace(6)), i32 0, i32 2, i32 0, <256 x i1> %mask)
  call void @llvm.hivm.vstsx1.v128bf16(<128 x bfloat> %gathered, ptr addrspace(6) inttoptr (i64 1280 to ptr addrspace(6)), i32 0, i32 2, i32 0, <256 x i1> %mask)
...
declare <128 x bfloat> @llvm.hivm.vsldb(ptr addrspace(6), i32, i32, <256 x i1>)
declare <128 x bfloat> @llvm.hivm.vgatherb.v310.v128bf16(ptr addrspace(6), <64 x i32>, <256 x i1>)
...
!1 = !{ptr @dav_memory_blocks_bf16, !"kernel", i32 1}
